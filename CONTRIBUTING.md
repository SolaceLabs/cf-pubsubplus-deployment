...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/SolaceLabs/cf-pubsubplus-deployment/issues).
...
* Search [GitHub](https://github.com/SolaceLabs/cf-pubsubplus-deployment/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceLabs/cf-pubsubplus-deployment) and clone your fork
locally.

```sh
git clone https://github.com/<my-github-repo>/cf-pubsubplus-deployment
```
...
```sh
$ git remote add upstream https://github.com/SolaceLabs/cf-pubsubplus-deployment
```
...
In GitHub, send a pull request to `cf-pubsubplus-deployment:master`. 
...
* Open a GitHub [enhancement request issue](https://github.com/SolaceLabs/cf-pubsubplus-deployment/issues/new) and describe the new functionality.
